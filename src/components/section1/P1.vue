...
export default {
  ...
  computed: {
    title() { return `1. You need to add ${this.amount} Ounces of Calcium Hypochlorine to your pool.\u00A0\u00A0How many pounds is this?` },
  ...
  methods: {
    ...
    newProblem() {
      ...
      this.correct = (this.amount / 16).toFixed(1);
      let newAnswers = [(this.amount / 2).toFixed(1) , this.correct, (this.correct / 4).toFixed(1), (this.correct / 8).toFixed(1)];
