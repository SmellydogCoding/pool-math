...
export default {
  data() {
    return {
      img: 'public/img/section1/problem4.jpg',
      alt: 'pool image for problem 4',
      amount: 10,
      answer: 0,
      attempts: 0,
      correct: 30,
      ...
      hintTitle: 'Hint for Problem 4',
      hintText: 'Yards * 3 = Feet',
      hintWidth: '500px',
      next: 'Problem 5: Inches to Feet',
      redo: 'New Yards to Feet Problem'
    }
  },
  components: {
  ...
  computed: {
    title() { return `1. Your pool is ${this.amount} Yards long.\u00A0\u00A0How many feet is this?` },
    correctMessage() { return `Correct!\u00A0\u00A0${this.amount} Yards * 3 = ${this.correct} Feet.` },
  ...
  methods: {
    ...
    newProblem() {
      ...
      this.correct = (this.amount * 3).toFixed(2);
      let newAnswers = [(this.amount * 5).toFixed(2) , this.correct, (this.amount * 1.5).toFixed(2), (this.amount * 2.5).toFixed(2)];
