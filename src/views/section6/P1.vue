...
export default {
  data() {
    return {
      ...
      newButton: 'New Turnover Rate Problem',
  ...
  computed: {
    title() { return `You have a ${this.units.volume} pool that has a flow rate of ${this.units.flow} Gallons Per Minute.\u00A0\u00A0What is the Turnover Rate of this pool?` },
