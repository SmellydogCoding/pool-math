...
export default {
  ...
  computed: {
    title() { return `You have a ${this.units.poolVolume} gallon pool.\u00A0\u00A0The current cyanuric acid in your pool is ${this.units.currentValue} ppm.\u00A0\u00A0You want to raise the cyanuric acid to ${this.units.newValue} ppm.\u00A0\u00A0How many ${this.units.conversionType} of ${this.units.chemicalName} are needed?` },
