...
export default {
  data() {
    return {
      ...
      next: {text: 'Problem 3: Chemical Adjustment - no label - Raise Alkalinity', route: '/s4p4'},
      newButton: 'New Add Chlorine without a Label Problem',
  ...
  computed: {
    title() { return `You have a ${this.units.poolVolume} gallon pool.\u00A0\u00A0The current free chlorine in your pool is ${this.units.currentValue} ppm.\u00A0\u00A0You want to raise the free chlorine to ${this.units.newValue} ppm using ${this.units.name}.\u00A0\u00A0How many ${this.units.conversionType} of ${this.units.name} are needed?` },
